...
export const metadata: Metadata = {
  title: {
    default: 'PawHaven — Premium Pet Products',
    template: '%s | PawHaven',
  },
  description: 'Thoughtfully crafted pet products for the modern pet parent. Premium nutrition, comfort, and care for your beloved companions.',
}
